                    ...
                    <div class="border border-2 border-success m-2 p-2 bg-white rounded " id="spec_table_add_div">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <form action="{{ Route('seller.UpdateProductSpec') }}" method="POST">
                                    <input type="hidden" name="spec_id" id="spec_id" value="{{$spec_id }}">
                                    @else
                                    <form action="{{ Route('seller.AddProductSpec') }}" method="POST">
                                    @endif
                                        @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="form-control" name="specification"  value="{{ isset($spec->specification)?$spec->specification:'' }}"  id="inputEmail4" placeholder="Specification">
                                        </div>
                                        <div class="form-group col-md-6">
                                        <label for="inputPassword4">Value</label>
                                        <input type="text" class="form-control" name="value" value="{{ isset($spec->value)?$spec->value:'' }}" id="inputPassword4" placeholder="Value">
                                        </div>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <form action="{{Route('seller.ProductSpecificationPage' ,[$product_det->id])}}" method="GET">
                                            ...
                                            <form action="{{  Route('seller.DeleteProductSpec') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="spec_id" value="{{ $spec->id }}">
