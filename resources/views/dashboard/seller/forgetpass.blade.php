...
<form class="pt-3" action="{{ route('seller.forgetpassword') }}" method="post">
    @if (Session::get('fail'))
    ...
    <div>
        ...
        <a href="{{ route('seller.home') }}" class="btn btn-gradient-secondary btn-sm float-right mx-2">Back to Login</a>
    </div>
  </div>
</form>
