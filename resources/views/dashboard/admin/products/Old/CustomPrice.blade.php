                            ...
                            <tbody>
                                @foreach ($product_stocks as $stock)
                                    <tr>
                                        ...
                                        <td>
                                            @if($stock->price_type != '1')
                                            <button type="button" class="btn btn-inverse-warning btn-sm update_custom_stock" data-toggle="tooltip"  data-entry_id="{{ $stock->product_entry }}"
                                                data-product_price="{{ $stock->product_price }}" data-qty="{{ $stock->quantities }}"  data-title="Update Stocks"><i class="mdi mdi-pencil"></i></button>
                                            <button type="button" class="btn btn-inverse-danger btn-sm delete_stock"data-toggle="tooltip" data-title="Delete Stock"><i class="mdi mdi-delete"></i></button>
                                            @else
                                            <button type="button" class="btn btn-inverse-warning btn-sm update_custom_stock" data-toggle="tooltip" data-entry_id="{{ $stock->product_entry }}"
                                                data-product_price="{{ $stock->product_price }}" data-qty="{{ $stock->quantities }}" data-title="Update Stocks"><i class="mdi mdi-pencil"></i>Update</button>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
