                            ...
                            @if (count($products) > 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p>
                                        <span class="badge rounded-pill bg-warning" title="Seller">{{ $product->seller_full_name_buss }}</span>
                                        <span class="badge rounded-pill bg-dark text-white" title="Category">{{ $product->categoryname }}</span>
                                        </p>
                                    </td>
                                    {{-- <td></td>
                                    <td></td> --}}
                                    ...
                                    <td>
                                        <p>
                                            <div class="d-flex flex-row justify-content-center">
                                                ...
                                                @endif
                                                 <a href="{{ Route('admin.ProductCutomStock', [$product->id]) }}"
                                                    @if ($product->product_combo == 0)
                                                        class="btn btn-outline-secondary mx-1 btn-sm">
                                                    @else
                                                        class="btn btn-outline-info mx-1 btn-sm">
