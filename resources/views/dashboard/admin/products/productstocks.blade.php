                    ...
                    <div class="tab-content mt-5">
                                ...
                                <div class="col-12 p-2">
                                    ...
                                    <form action="{{ Route('admin.UpdateStockInfo') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="product_price" id="update_price" value="" class="form-control" placeholder="" required>
                                        </div>
                        ...
                        <div class="tab-pane" id="custom_price_form" role="tabpanel">
                            <div class="border border-2 border-secondary m-2 p-2 bg-white rounded ">
                                ...
                                <form action="{{ route('admin.AddProductStock') }}" method="post" autocomplete="off">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="table-responsive">
