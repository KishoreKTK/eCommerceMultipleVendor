            ...
            <div class="card">
                <div class="d-flex justify-content-start border bg-light">
                    <ul class="nav nav-pills nav-fill">
                        <li class="nav-item">
                          <a class="nav-link" href="{{ Route('admin.ProductSpecificationPage' ,[$product_det->id]) }}">Specifications</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card-body" id="show_table_list">
                    ...
                    <div class="alert alert-warning" role="alert">
                        <strong>Note:</strong>
                        <small>for Options with Multiple values please add comma and add multiple values.
                    ...
                    <div class="border border-2 border-primary m-2 p-2 bg-white rounded ">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ Route("admin.AddProductOptions") }}" method="POST">
                                    @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <form action="{{  Route('admin.DeleteProductOption') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="product_id" value="{{ $product_det->id }}">
                ...
                <div class="card-body" id="UpdateAttributeID">
                    ...
                    <hr>
                    <form action="{{ Route('admin.UpdateProductOption') }}" method="post">
                        @csrf
