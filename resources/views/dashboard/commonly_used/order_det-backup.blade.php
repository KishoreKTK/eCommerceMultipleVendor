...
=======
                    <h4 class="card-title">Products</h4>
                    <div class="table-responsive">
>>>>>>> 95317e298bce1aade582e17682ab4f303cb22738
...
<<<<<<< HEAD
                ...
                @else
                <button type="button" class="btn btn-outline-warning update_order_status m-2"
                    data-suborder_id="{{ $order_det['myorderid'] }}" data-current_status="{{ $order->order_status_id }}"
                    data-curr_statusname="{{ $order->statusname }}" data-order_id="{{ $order->order_id }}"
                    @if(strpos($routeName, 'admin.' )===0) data-route_name="admin" @else data-route_name="seller" @endif
                    data-order_type="{{ $order->order_type }}" data- data-toggle="tooltip" data-placement="top"
