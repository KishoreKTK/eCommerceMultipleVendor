                                          ...
                                          <table class="p100"
                                             ...
                                             <tr>
                                                <td style="color: #FF4500; font-family: 'Roboto', sans-serif; font-size: 40px; font-weight: 800; line-height: 20px; mso-line-height-rule: exactly;"
                                                   ...
                                                   <font face="'Roboto', sans-serif">ORDER PLACED
                                                   </font>
                                                </td>
                                             </tr>
                                             ...
                                             <tr>
                                                <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                   ...
                                                   <font face="'Roboto', sans-serif">Dear Kishore,
                                                   </font>
                                                </td>
                                             </tr>
                                             <tr>
                                             ...
                                             <tr>
                                                <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                   ...
                                                   Your order <bold>#STG220427036</bold> is awaiting approval from the seller. You will receive a notificaion once your order is approved.
                                                   Thank you for creating a {{ config('app.name') }} account.
                                                   </font>
                                                </td>
                                             </tr>
                                             <tr>
                                                        ...
                                                        <tr>
                                                                                   ...
                                                                                   <tbody>
                                                                                      <tr>
                                                                                         ...
                                                                                         <td width="40%" class="o_pt-xs" align="right" style="padding-top: 8px;">
                                                                                            <p class="o_sans o_text-xs o_text-dark_light" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;color: #a0a3ab;">VR72654</p>
                                                                                         </td>
                                                                                      </tr>
                                                                                      <tr>
                                                                                         <td width="60%" class="o_pt-xs" align="left" style="padding-top: 8px;">
                                                                                            <p class="o_sans o_text-xs o_text-dark_light" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;color: #a0a3ab;">Order Date:</p>
                                                                                         </td>
                                                                                         <td width="40%" class="o_pt-xs" align="right" style="padding-top: 8px;">
                                                                                            <p class="o_sans o_text-xs o_text-dark_light" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;color: #a0a3ab;">March 15, 2018</p>
                                                                                         </td>
                                                                                      </tr>
                                                                                      <tr>
                                                                                         <td width="60%" class="o_pt-xs" align="left" style="padding-top: 8px;">
                                                                                         ...
                                                                                         <td width="40%" class="o_pt-xs" align="right" style="padding-top: 8px;">
                                                                                            <p class="o_sans o_text-xs o_text-dark_light" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;color: #a0a3ab;">Pickup</p>
                                                                                         </td>
                                                                                      </tr>
                                                                                      <tr>
                                                                                         <td width="60%" class="o_pt-xs" align="left" style="padding-top: 8px;">
                                                                                         ...
                                                                                         <td width="40%" class="o_pt-xs" align="right" style="padding-top: 8px;">
                                                                                            <p class="o_sans o_text-xs o_text-success" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;color: #0ec06e;"><strong>2,050 AED</strong></p>
                                                                                         </td>
                                                                                      </tr>
                                                                                   </tbody>
                                                                                </table>
                                                            ...
                                                            <td style="width: 280px;margin-right: 20px;padding: 20px;">
                                                                <div class="o_px-xs o_sans o_text o_text-secondary o_left o_xs-center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;text-align: left;padding-left: 8px;padding-right: 8px;">
                                                                    <p class="o_text-xxs o_caps o_text-light o_mb-xs" style="text-transform: uppercase;letter-spacing: 1px;font-size: 12px;line-height: 19px;color: #82899a;margin-top: 0px;margin-bottom: 8px;">Bill To</p>
                                                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><strong>Clara Palmer</strong><br>
                                                                       clara.palmer@customservice.eu<br>
                                                                       555-555-5555
                                                                    </p>
                                                                    <p style="margin-top: 0px;margin-bottom: 0px;">3333 Poplar Street<br>
                                                                       Chicago, IL 60603<br>
                                                                       United States
                                                                    </p>
                                                                 </div>
                                             ...
                                             {{-- <tr>
                                                <td class="o_re o_bg-white o_px o_pb-md" align="left" style="font-size: 0;vertical-align: top;background-color: #ffffff;padding-left: 16px;padding-right: 16px;padding-bottom: 24px;">
                                                    <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                                                        <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0">
                                                           <tbody>
                                                              <tr>
                                             ...
                                             <tr>
                                                <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                   valign="top" align="left">
                                                   <font face="'Roboto', sans-serif">Thank you for placing an order with us.
                                                   </font>
                                                </td>
                                             </tr>
                                             <tr>
