...
{{--
                                                        ...
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <font face="'Roboto', sans-serif">We got a request to reset your {{ config('app.name') }} password.
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <font face="'Roboto', sans-serif">You can reset your password by clicking the button below:
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <font face="'Roboto', sans-serif">If you ignore this message, your password will not be changed. If you didn't request a password reset, let us know.
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
