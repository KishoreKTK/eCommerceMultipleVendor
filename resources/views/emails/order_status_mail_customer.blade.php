                                        ...
                                        <td align="center" valign="top">
                                            <table class="p100"
                                                ...
                                                <tr>
                                                    ...
                                                    <font face="'Roboto', sans-serif">Dear {{ $data['user_name'] }},
                                                    </font>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <font face="'Roboto', sans-serif">
                                                            @if ($data['status_id'] == '1')
                                                                Your order <bold>#{{ $data['order_id'] }}</bold> is awaiting approval from the seller. You will receive a notificaion once your order is approved.
                                                            @elseif ($data['status_id'] == '2')
                                                                Your order <bold>#{{ $data['order_id'] }}</bold> is rejected by the seller. You payment will be refunded within a short time.
                                                            @elseif ($data['status_id'] == '3')
                                                                Your order <bold>#{{ $data['order_id'] }}</bold> is accepted by the seller. You will receive a notificaion once your order is ready for {{ $order_type }}.
                                                            @elseif ($data['status_id'] == '5')
                                                                Your order <bold>#{{ $data['order_id'] }}</bold> is ready for {{ $order_type }}, Please bring your confirmation mail when you come to collect your order.
                                                            @elseif ($data['status_id'] == '6')
                                                                Your order <bold>#{{ $data['order_id'] }}</bold> has Shipped.
                                                            @else
                                                                Your order <bold>#{{ $data['order_id'] }}</bold> Completed.
                                                            @endif.
                                                        </font>
                                                    </td>
                                                </tr>
