...
{{--
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 20px; font-weight: 700; line-height: 20px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <font face="'Roboto', sans-serif">Welcome to {{ config('app.name') }}!
                                                                </font>
                                                            </td>
                                                        </tr> --}}
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <font face="'Roboto', sans-serif">Dear {{ $data['name'] }},
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <font face="'Roboto', sans-serif">Thank you for creating a {{ config('app.name') }} account.
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <font face="'Roboto', sans-serif">To help us confirm it’s you, please verify your email address by clicking the button below:
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;background-color: #ef814c; color: #ffffff; font-family: 'Roboto', sans-serif; font-weight: 700; line-height: 100%; mso-line-height-rule: exactly; padding: 11px 20px; vertical-align: middle;"
                                                                                                align="center"
                                                                                                valign="top">
                                                                                                <a href="{{url('/')}}/VerifyEmail?email={{$data['mail']}}"
                                                                                                    target="_blank"
                                                                                                    style="border: none; color: #ffffff; display: block; font-family: 'Roboto', sans-serif; font-size: inherit; font-weight: 700; outline: none; text-decoration: none;">Verify
                                                                                                    Email</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                        ...
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <font face="'Roboto', sans-serif">If you were not expecting this email, or you think you received it in error, let us know.
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td style="color: #ffffff; font-family: 'Roboto', sans-serif; font-size: 13px; font-weight: normal; letter-spacing: 0.02em; line-height: 20px; text-align: center; mso-line-height-rule: exactly;"
                                                            ...
                                                            <font face="'Roboto', sans-serif">&copy; <script
                                                                ...
                                                                </script> {{ config('app.name') }}. All right reserved.</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px; line-height: 10px; font-size: 1px; mso-line-height-rule: exactly;"
