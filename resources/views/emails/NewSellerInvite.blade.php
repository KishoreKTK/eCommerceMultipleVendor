                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <table class="p100"
                                                        ...
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 11px; font-weight: 200; line-height: 23px; mso-line-height-rule: exactly;"
                                                                valign="top" align="left">
                                                                <font face="'Roboto', sans-serif"> Please use this Email Id for both Username and Password to Login as first time seller and Update Your Password for Security Purpose.</font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="height: 20px; line-height: 20px; font-size: 1px; mso-line-height-rule: exactly;"
