...
Route::prefix('seller')->name('seller.')->group(function(){
    ...
    Route::middleware(['auth:seller','PreventBackHistory','seller'])->group(function()
    {
        // Route::view('/','dashboard.seller.home')->name('home');
        // Route::view('/map_test','dashboard.seller.map')->name('map');
        ...
        Route::post('updatesellerloc',[SellerSettingsController::class,'UpdateSellerLocation'])->name('UpdateSellerLocation');
        ...
        Route::prefix('products')->group(function()
        {
            ...
            // V2 
            Route::get('product-custom-stock/{id}',[SellerProductController::class,'ProductCutomStock'])->name('ProductCutomStock');
            Route::post('/post-add-option',[SellerProductController::class,'InsertOptionsNew'])->name('addoptionsv2');
            Route::post('update-standard-price-data',[SellerProductController::class,'UpdateStandardPrice'])->name('UpdateStandardPrice');
            Route::post('update-additional-image',[SellerProductController::class,'UpdateAdditionalImage'])->name('UpdateProductImage');
            Route::post('delete-additional-image',[SellerProductController::class,'DeleteProductImage'])->name('DeleteProductImage');
        ...
        Route::prefix('order')->group(function(){
            ...
            Route::post('update-payment-status',[SellerOrderController::class,'UpdatePaymentStatus'])->name('updatepaymentstatus');
        ...
        Route::prefix('settings')->group(function(){
            ...
            Route::get('order-settings-edit/{id}',[SellerSettingsController::class,'EditSellerOrderSettingsPage'])->name('EditSellerOrderSettingsPage');
        });
    });
});
